...
X11LIB = /nix/store/cq72jwk3ypi5br1xv5inmxq9xvjn6n3c-xproto-7.0.26/lib -L/nix/store/7plr96lk6sb43z5zcqlg0w70pxbsrx0l-libX11-1.6.2/lib -L/nix/store/vlx1fnpr4y119lfhbrsgi3zdn2sjww06-libXinerama-1.1.3/lib
...
CFLAGS   =  -std=c99 -pedantic -Wall -Wno-deprecated-declarations ${INCS} ${CPPFLAGS} -Os
